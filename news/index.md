...
- Preserves explicit row identity when only some row names resemble
  generated `sample_<integer>` identifiers; only fully generic sequences
  are now treated as generated when `id` is omitted.
